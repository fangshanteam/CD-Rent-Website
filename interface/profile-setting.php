                    ...
                    <div class="single-sidebar">
                        ...
                        <ul>
                            ...
                            <li><a href="">The Eagle</a></li>
								...
								<br>
								<form action="proseschange.php" method="post">

                                <p class="form-row form-row-first">
                                    <label for="password">Your Old Password <span class="required">*</span>
                                    </label>
                                    <input type="password" id="password" name="password" class="input-text">
                                </p>
                                <p class="form-row form-row-last">
                                    <label for="newpassword">Your New Password <span class="required">*</span>
                                    </label>
