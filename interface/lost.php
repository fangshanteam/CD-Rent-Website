    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
				<h1>How to get your account back?</h1>
				<br>
				<br>
				<h5>1. Contact Administrator from widget chat online</h5>
				<h5>2. Tell Administrator to change your password</h5>
				<h5>3. Admin will ask about your username, email, phone number</h5>
				<h5>4. Admin will check valid your information</h5>
				<h5>5. If valid admin will change to random and send to you</h5>
				<br>
                              
                                    </tbody>
                                </h3> 
								<a href="login.php"><button class="button" value="1" name="calc_shipping" type="submit">Already Contact? Let's Login</button></a>
...
<?
	...
	s1.async=true;
	s1.src='https://embed.tawk.to/585a2277e7588f121246f8e7/default';
	s1.charset='UTF-8';
