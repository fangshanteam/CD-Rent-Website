...
$sql = "SELECT firstname, lastname, country, address, city, postcode, email, phone from user WHERE username='$username'";
$result = $db->query($sql);
...
?>
								...
								<a href="profile-setting.php"><button class="button" value="1" name="calc_shipping" type="submit">Setting Account</button></a>								
								<a href="index.php"><button class="button" value="1" name="calc_shipping" type="submit">Back to Home</button></a>
