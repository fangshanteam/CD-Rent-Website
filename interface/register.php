                                ...
                                <div id="customer_details" class="col2-set">
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
											...
											<p id="username" class="form-row form-row-first validate-required">
                                                <label class="" for="username">Username <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Your Username" id="username" name="username" class="input-text ">
                                            </p>
                                            <p id="firstname" class="form-row form-row-first validate-required">
                                                <label class="" for="firstname">First Name <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Your Firstname" id="firstname" name="firstname" class="input-text ">
                                            </p>

                                            <p id="lastname" class="form-row form-row-last validate-required">
                                                <label class="" for="lastname">Last Name <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Your Lastname" id="lastname" name="lastname" class="input-text ">
                                            </p>
                                            <div class="clear"></div>

                                            <p id="billing_country_field" class="form-row form-row-wide">
                                                <label class="" for="country">Country</label>
                                                <input type="text" value="" placeholder="Country Name" id="country" name="country" class="input-text ">
                                            </p>
                                            ...
                                            <p id="city" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <p id="postcode" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                            ...
                                            <p id="email" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="email">Email Address <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="email@domain.com" id="email" name="email" class="input-text ">
                                            </p>

                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                <label class="" for="phone">Phone <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Phone Number" id="phone" name="phone" class="input-text ">
                                            </p>
                                            <div class="clear"></div>


                                            <div class="create-account">
                                                <p id="password" class="form-row validate-required">
